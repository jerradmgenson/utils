...
(custom-set-variables
 ...
 '(package-selected-packages (quote (github-elpa elpy)))
 '(show-paren-mode t))
...
;; Configure custom font and theme

(load-file "~/.emacs.d/color-theme-tomorrow.el")
(load-file "~/.emacs.d/tomorrow-night.el")
(load-file "~/.emacs.d/column-marker.el")
(add-to-list 'default-frame-alist '(font . "Ubuntu Mono-11.0" ))
"""
